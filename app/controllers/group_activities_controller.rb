  ...
  def create
    ...
    respond_to do |format|
      if @group_activity.save
        format.html do
          redirect_to group_activity_url(@group_activity), notice: 'Group activity was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @group_activity.update(group_activity_params)
        format.html do
          redirect_to group_activity_url(@group_activity), notice: 'Group activity was successfully updated.'
        end
